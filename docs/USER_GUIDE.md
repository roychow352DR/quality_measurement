...
- Discovery counts and their derived weekly average remain informational and excluded from scores and scored-coverage denominators. UAT Discovery Rate is scored once under the internal pilot rules below. Other metrics and aggregation rules retain their previous behavior.
